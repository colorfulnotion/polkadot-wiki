...
- [Polkadot Governance Dashboard](https://dune.com/substrate/polkadot-gov): The _Polkadot Governance
  ...
  [network's governance](../../../learn/learn-polkadot-opengov.md) activities. It serves as a useful
  tool for community members to observe
  [treasury management](../../../learn/learn-polkadot-opengov-treasury.md),
  [referendum outcomes](../../../learn/learn-polkadot-opengov.md#referenda), and voting patterns.
  This dashboard aims to enhance community engagement by simplifying access to governance
...
[staking web app documentation](../../../general/staking-dashboard.md).
